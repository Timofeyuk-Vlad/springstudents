...
public interface ForumPostMapper {
    ...
    @Mapping(source = "author", target = "authorFullName", qualifiedByName = "getStudentFullName")
    ...
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "author", ignore = true)
    void updateEntityFromDto(CreateForumPostRequestDto dto,
                             @MappingTarget ForumPost post);
}